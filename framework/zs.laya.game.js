window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function (e, s) {
    ...
    t.NET_XHR_RESPONSE = zs.laya.XHRUtils.NET_XHR_RESPONSE, t.APP_SHOW = zs.laya.sdk.DeviceService.EVENT_ON_SHOW,
        ...
        t.PLATFORM_ADD_COIN = "PLATFORM_ADD_COIN", t.RECORDER_VIDEO_RANK = "RECORDER_VIDEO_RANK", t.REPLAY = "REPLAY",
    ...
    class i {
        ...
        static requestBaseCfg(e) {
            var a = e || {}, o = n, r = !1;
            o.appConfig.configVersion && (a.v_type = o.appConfig.configVersion, r = !0),


                // this.UseWebApi ? (
                this.RequestSign && r ? zs.laya.XHRUtils.xhrPostWithSignAndHeader(this.WebApiMap.gameCfg, a, this.RequestSign, i.RequestHeader)
                    : zs.laya.XHRUtils.xhrPost(this.WebApiMap.gameCfg, a),
                console.log(this.WebApiMap.gameCfg)

            // ) : (console.log(this.WebApiMap.gameCfg), s.stage.frameOnce(1, this, function () {
    ...
    class n extends s.Script {
        ...
        onAwake() {
            zs.laya.tdapp.tdAppSdk.event(new zs.laya.tdapp.startupEvt()), zs.laya.sdk.SdkService.initSDK(),
                ...
                s.stage.on(t.REPLAY, this, this.onReplay),
        ...
        onDestroy() {
            s.stage.off(t.GAME_HOME, this, this.onGameHome), s.stage.off(t.GAME_PREPARE, this, this.onGamePrepare),
                ...
                s.stage.off(t.REPLAY, this, this.onReplay),
        ...
        loadSubpackage() {
            ...
            // n.appConfig.bgm && (zs.laya.platform.ADConfig.zs_bgm_change ? n.appConfig.bgm2 && zs.laya.SoundService.playMusic(n.appConfig.bgm2) : 
            // zs.laya.SoundService.playMusic(n.appConfig.bgm)),
            this.currentLoadStep++, this.loadBaseConfig(), this.loadFont();
        }
        loadBaseConfig() {
            var e = [];
            ...
            if (this.launchResReady && this.isCFGReady) {
                ...
                if (e) {
                    ...
                    this.isLoginSuccess ? (a.playerInfo.gold > n.playerInfo.gold && (n.playerInfo.gold = Number(a.playerInfo.gold)),
                        a.playerInfo.level_id > n.playerInfo.level_id && (n.playerInfo.level_id = Number(a.playerInfo.level_id)))
                        : n.playerInfo = a.playerInfo;
                } else this.isLoginSuccess || (n.playerInfo = n.appConfig.defaultCfg.playerInfo);
                null != n.playerInfo.gold && null != n.playerInfo.gold || (n.playerInfo.gold = n.appConfig.defaultCfg.playerInfo.gold ?
                    Number(n.appConfig.defaultCfg.playerInfo.gold) : 0),
        ...
        onGameHome(e) {
            n.GameState = a.STATE_UNBEGIN, 0 == n.autoStartNext ?
                platform.getInstance().yadstartup("Super-Heels", () => {
                    platform.getInstance().needStartUp && (window.yad.on(Laya.Event.MOUSE_DOWN, window.yad, () => {
                        platform.getInstance().navigate("GAME", "LOGO");
                    }), n.appConfig.bgm && (Laya.SoundManager.playMusic(n.appConfig.bgm)))
                    o.showHome(e)
                })
                : s.timer.frameOnce(2, this, function () {
                    s.stage.event(t.GAME_PREPARE);
                }), n.storeItemsDic || i.requestStoreData(n.webRequestAdapter.reqStoreCFgArgs());
        }
        onGamePrepare(e) {
            n.GameState != a.STATE_PREPARE && (this.nextResWait = !1, this.nextResReady = !1,
                n.GameState = a.STATE_PREPARE,
                //  n.appConfig.bgm && (zs.laya.platform.ADConfig.zs_bgm_change ?
                //     n.appConfig.bgm2 && zs.laya.SoundService.playMusic(n.appConfig.bgm2) : zs.laya.SoundService.playMusic(n.appConfig.bgm)),
        ...
        onReplay() {
            this.gameAccountAndUpload(), n.reliveChance = 2, o.hideRelive(), o.hidePlaying(),
                o.hideScore(), zs.laya.platform.PlatformMgr.onGameOverPopUp({
                    gold: n.levelData.rewardGold,
                    isBackHome: !n.autoStartNext
                }), n.GameState != a.STATE_PREPARE && (this.nextResWait = !1, this.nextResReady = !1,
                    n.GameState = a.STATE_PREPARE,
                    ...
                    //     n.appConfig.bgm2 && zs.laya.SoundService.playMusic(n.appConfig.bgm2) : zs.laya.SoundService.playMusic(n.appConfig.bgm)),
                    o.hideHome(), o.showPlaying(e));
            s.stage.event(zs.laya.game.EventId.GAME_PREPARE);
        }
        onGameOverToStart() {
            this.nextResReady ? (console.log("游戏结束调用了返回首页"), s.stage.event(t.GAME_HOME)) : this.nextResWait = !0,
                n.isWin = !1;
        }
        onNextResCom() {
        ...
        onGameRelive() {
            n.GameState == a.STATE_PAUSE && (
                // n.appConfig.bgm && (
                // zs.laya.platform.ADConfig.zs_bgm_change ? n.appConfig.bgm2 &&
                //     zs.laya.SoundService.playMusic(n.appConfig.bgm2) : zs.laya.SoundService.playMusic(n.appConfig.bgm)),
        ...
        onGameShow() {
            ...
            // n.appConfig && n.appConfig.bgm && !zs.laya.SoundService.videoPlaying
            //     && (zs.laya.platform.ADConfig.zs_bgm_change ? n.appConfig.bgm2 && zs.laya.SoundService.playMusic(n.appConfig.bgm2)
            //         : zs.laya.SoundService.playMusic(n.appConfig.bgm));
        }
        onGameHide() {
            Laya.timer.scale = 0;
