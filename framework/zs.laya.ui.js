window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function (e, t) {
    ...
    class n extends t.Script {
        ...
        onAwake() {
            ...
            // this.statusClip.addComponent(r);
        }
        onEnable() {
        ...
        onClick() {
            ...
            // }, [Date.now()]), zs.laya.sdk.SdkService.openShare(zs.laya.platform.ADConfig.zs_share_title, zs.laya.platform.ADConfig.zs_share_image)) :
            //  2 == this.statusClip.index ? this.relive() :
            //   this.onContinue();
        ...
        onContinue() {
            ...
            t.stage.event(zs.laya.game.EventId.REPLAY);
        }
        onRelive() { }
    }
    ...
    class B extends zs.laya.base.ZhiSeView {
        ...
        onAwake() {
            ...
            s && (this.homeBtn = this.homeBtn || s.getChildByName("homeBtn"), this.nextBtn = this.nextBtn || s.getChildByName("nextBtn")),
                this.homeBtn && this.homeBtn.addComponent(r), this.nextBtn && this.nextBtn.addComponent(r);//nextBtn d
            platform.getInstance().initList(this.owner.getChildByName("list_showList"))
        }
    }
