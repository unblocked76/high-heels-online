window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(t, i) {
    ...
    class s {
        ...
        static initCustomeAd(t, i, s, e, n) {
            this._instance && this._instance.initCustomeAd(t, i, s, e, n);
        }
        static checkCustomAd(t, i, s) {
            this._instance && this._instance.checkCustomAd(t, i, s);
        }
        static hideCustomAd() {
    ...
    class n {
        ...
        static navigate2Mini(t, i, s, e, n) {
            this.Instance.navigate2Mini(t, i, s, e, n);
        }
