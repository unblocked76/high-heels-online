var conf = window.zs.wx, reportSdk = function() {
    var n = {}, e = conf.adApiUrl, t = function(n, e) {
        ...
        }, u = l(s), c = Object.assign({}, s, {
            sign: u
        }), p("", c, "POST", function() {}, function() {
    ...
    n.adJumpAppId = null, n.isEnableExportAdLinkId = "0", n.init = function(e, t) {
        ...
        if (t) e(t); else if (this.inAdRequest) this.adCbList.push(e); else {
            ...
            p("", r, "POST", function(e) {
                ...
                m("zsAd", o), console.log("ljc", "zsAd", o);
    ...
    }, n.navigate2Mini = function(e, t, o, i, a) {
        var r = e, s = h("unClickAd") || {}, u = h("unlinkAd") || {};
        if (console.log(JSON.stringify(s)), s[r.appid]) {
            console.log("广告位今日点击过");
            var c = [], l = g("zsAd");
            for (const n in l) if (l.hasOwnProperty(n)) {
                var p = l[n];
            ...
            var d = c.filter(n => !u[n.appid]), f = Math.floor(Math.random() * d.length);
            r = d[f], console.log("新的导出", r);
        }
        return r ? (u[r.appid] = !0, m("unlinkAd", u), console.log(JSON.stringify(u)), "undefined" == typeof wx ? (I(i) && i(), 
        void (I(a) && a())) : (r.extraData = r.extraData || {}, void wx.navigateToMiniProgram({
            appId: r.appid,
            path: r.link_path,
            extraData: r.extraData,
            success: function(n) {
                s[r.appid] = !0, m("unClickAd", s), C(r, t), I(o) && o();
            },
            fail: function(n) {
                I(i) && i();
            },
